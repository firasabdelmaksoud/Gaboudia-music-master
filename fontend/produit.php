                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="about--content mb-100">
                            ...
                            <!-- Key Notes -->
                            <ul class="key-notes">
                                <li><div class="check"><img src="img/core-img/check.png" alt=""></div>PRIX : </li>
                                <li><div class="check"><img src="img/core-img/check.png" alt=""></div>MARQUE : </li>
                                <li><div class="check"><img src="img/core-img/check.png" alt=""></div>CATEGORIE: </li>
									<form  method="get" action="ajoutertopanier.php" >
                                <li>
								<input type="hidden" name="id" value="<?php echo $_GET['id'] ?>">
                                   <input type="hidden" name="panier">
								   <input type="submit" name="ajouter"  class="btn musica-btn btn-2 m-2" value="add to my cart">
								   </form></li>
                            </ul>
                        </div>
                    </div>
